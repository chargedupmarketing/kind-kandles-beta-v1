  ...
  const roomSprayProducts = [
    {
      ...
      description: 'Eucalyptus and spearmint room spray for instant relaxation'
    }
  ];
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold mb-4">Room Sprays</h1>
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Transform your space instantly with our premium room sprays, crafted with natural essential oils for a refreshing ambiance.
            </p>
          </div>
        </div>
      </section>
