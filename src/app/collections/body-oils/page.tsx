  ...
  const bodyOilProducts = [
    {
      ...
      description: 'Nourishing oil blend for healthy hair growth'
    },
    {
      id: 'beard-oil',
      ...
      description: 'Premium beard oil for grooming and conditioning'
    }
  ];
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold mb-4">Body Oils</h1>
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Nourishing oils crafted with natural ingredients to moisturize, condition, and promote healthy hair and skin.
            </p>
          </div>
        </div>
      </section>
