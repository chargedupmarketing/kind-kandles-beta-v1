...
export default function HandmadeLotionPage() {
  const handmadeLotions = [
    { id: 'calm-down-girl-lotion', name: 'Calm Down Girl Lotion', price: '$16.00', href: '/products/calm-down-girl-lotion', description: 'Soothing eucalyptus and spearmint moisturizing lotion' },
  ];
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold mb-4">Handmade Lotion</h1>
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Rich, moisturizing lotions handcrafted with natural ingredients for soft, healthy skin.
            </p>
          </div>
        </div>
      </section>
