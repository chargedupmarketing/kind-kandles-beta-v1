...
export default function HerbalCandlesPage() {
  const herbalCandles = [
    { id: 'ginger-spice', name: 'Ginger Spice', price: '$22.00', href: '/products/ginger-spice', description: 'Warm ginger with aromatic spices' },
  ];
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold mb-4">Herbal Candles</h1>
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Natural herbal and spice blends that create warming, therapeutic atmospheres.
            </p>
          </div>
        </div>
      </section>
