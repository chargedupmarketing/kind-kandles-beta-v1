      ...
      <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-lg w-full p-8 text-center transform animate-fade-in">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
            Our <span className="font-semibold text-teal-600 dark:text-teal-400">Custom Candle Making Experience</span> page 
            is currently under active development. We're working hard to bring you an amazing booking and customization experience!
          </p>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4 mb-6">
            ...
            <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
              ...
              <li className="flex items-center justify-center gap-2">
                <span className="text-teal-500">✓</span> Custom scent builder
              </li>
              <li className="flex items-center justify-center gap-2">
                <span className="text-teal-500">✓</span> Event scheduling
              </li>
              <li className="flex items-center justify-center gap-2">
                <span className="text-teal-500">✓</span> Quote request form
              </li>
            </ul>
          </div>
