...
export const metadata: Metadata = generatePageMetadata({
  ...
  description: 'Create your own custom candles or book a candle making experience for parties and events. Perfect for birthdays, bridal showers, and team building in Maryland.',
