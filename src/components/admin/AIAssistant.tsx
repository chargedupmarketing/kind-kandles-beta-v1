    ...
    <div className="h-[calc(100vh-200px)] flex flex-col">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">AI Business Assistant</h2>
            <p className="text-slate-600 dark:text-slate-400 text-sm">Powered by OpenAI • {config.model}</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg disabled:opacity-50 transition-colors"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-100 disabled:opacity-50"
          >
      ...
      {/* Settings Panel */}
      {showSettings && (
        <div className="mb-4 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="sk-..."
                  className="w-full px-4 py-3 pr-20 border rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-slate-700 dark:border-slate-600 font-mono text-sm"
                />
                <button
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-slate-700 dark:border-slate-600"
              >
              ...
              <p className="text-xs text-slate-500 mt-1">
                Recommended: GPT-4o Mini for best balance of speed and capability
              </p>
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                rows={6}
                className="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-purple-500 dark:bg-slate-700 dark:border-slate-600 text-sm"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full max-w-2xl">
                {SUGGESTED_PROMPTS.map((suggestion, index) => (
                  <button
                    ...
                    className="flex items-start gap-3 p-4 bg-slate-50 dark:bg-slate-700 hover:bg-slate-100 dark:hover:bg-slate-600 rounded-lg text-left transition-colors disabled:opacity-50"
                  >
                    <suggestion.icon className="h-5 w-5 text-purple-500 mt-0.5" />
                    <div>
                      <p className="font-medium text-slate-900 dark:text-white text-sm">{suggestion.title}</p>
            ...
            messages.map((message) => (
              ...
              >
                ...
                >
                  ...
                  {message.role === 'assistant' && (
                    <div className="flex items-center justify-end gap-2 mt-2 pt-2 border-t border-slate-200 dark:border-slate-600">
                      <button
        ...
        <div className="p-4 border-t dark:border-slate-700">
          <div className="flex items-center gap-3">
            <input
              ...
              placeholder={config.apiKey ? "Ask me anything about your business..." : "Configure API key to start..."}
              disabled={!config.apiKey || isLoading}
              className="flex-1 px-4 py-3 border rounded-xl focus:ring-2 focus:ring-purple-500 dark:bg-slate-700 dark:border-slate-600 disabled:opacity-50"
            />
            <button
              onClick={() => sendMessage()}
